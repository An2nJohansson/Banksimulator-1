    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                }   //Utvärdering: 1:Tycker min lösning är bra överensstämmande med uppgiftspecifikationen.
                    // 2: Jag tycker att jag valt bra variabeltyper med rätt datatyp och väö motiverat val av kontrollstrukturer och algoritmer.
                    // 3: Mitt program är användarvänligt, man får veta allt man behöver veta och när ett segment är klart får man upp menyn igen.
                    // 4: Programmet är stabilt, jag har provat det om och om igen och inte hittat buggar/kraschar.
                    // 5: Tycker strukturen är bra, koden är läsbar och väl dokumenterad enligt mig.

                    // Flödesschema och pseukod finns i ett och samma word-dokument i zip-filen.
            }
